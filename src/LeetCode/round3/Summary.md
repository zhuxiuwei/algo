...
[295. Find Median from Data Stream - Hard](https://github.com/zhuxiuwei/algo/blob/master/src/LeetCode/round3/HARD_P025_K个一组翻转链表.java) ★★★★
* 写起来比较复杂。
* 最开始的包里思路写法，会超时
* 然后使用了二维数组降低查找时间。稍微类似__跳表__的思路。转换逻辑有点复杂，写得很花时间。
