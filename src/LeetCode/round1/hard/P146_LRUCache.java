...
public class P146_LRUCache {
	...
	/**
	 * AC: 45.33%
	 * 属于本身逻辑不算复杂，但是实现起来步骤多、繁琐，容易出错的问题。
	 * ！！！！！！！！！几个问题：！！！！！！！！！！！！！
	...
	private Map<Integer, LRUCacheNode> cache = new HashMap<Integer, LRUCacheNode>();	//key: LRUCache key, value: array of size 3: {value, pre_key, next_key}
    ...
    public void put(int key, int value) {
    	...
    	{
	        if(cache.size() < capacity){	//not reach capacity, just add to tail.
	        	if(cache.size() == 0){
	        		tail = node;
	        		head = node;
	        	}else{
